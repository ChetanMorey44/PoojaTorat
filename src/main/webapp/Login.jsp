...
%>
 --%>
  ...
  <form action="#" method="get">
    ...
    <div>
<button class="btn btn-primary p-2 mt-2 me-2" type="submit" name="submit" >Login</button>
<span type="submit" name="cancel" ><a href="index.jsp" class="btn btn-warning p-2 mt-2">Cancel</a></span>
</div>
  </form>
</div>
</body>
